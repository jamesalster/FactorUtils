...
@testset "Methods" begin
    ...
    @test unique_variance(fa_fu) ≈ 1 .- dropdims(sum(MultivariateStats.loadings(fa_ms) .^ 2; dims = 2); dims = 2)
    ...
    ## TODO add test for cos2 ind
    @test unique_variance(pca_fu) ≈ 1 .- dropdims(sum(MultivariateStats.loadings(pca_ms) .^ 2; dims = 2); dims = 2)
...
@testset "Pretty Printing" begin
    ...
    arr_3d = NamedArray(rand(2, 2, 2), (["a", "b"], ["c", "d"], ["e", "f"]), ("dim1", "dim2", "dim3"))
